...
class Index:
    def __init__(self, index_name, table_path):
        self.path = os.path.join(table_path, SchemaKeys.INDEX_KEYS, index_name)
    ...
    def get_primary_keys(self, value_name):
        value_path = os.path.join(self.path, value_name + FILE_EXTENSION)
